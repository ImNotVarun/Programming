...
while not done:
    ...
    screen.fill(white)
    draw_maze(maze)
    rect = pygame.Rect(player_x*block_size+5, player_y *
                       block_size+5, block_size-10, block_size-10)
    ...
    if player_x == end_x and player_y == end_y:
        ...
        text = font.render(
            "Congratulations! You've reached the end of the Maze!", True, red)
